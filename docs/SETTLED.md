...
FLAG masked-pitch-auxiliary-head | PROVISIONAL PASS | paired mean +89.858/+72.361/+18.432, t=7.882/4.980/4.083; fixed-w10 route +14.891/+140.131/+9.390 | 실제 현재구종은 75.17% strict 1:1 학습행에서만 masked CE 보조라벨로 쓰고 추론은 제구 head만 사용한다. 직접 predicted-pitch MoE보다 강하며 세 rolling 전체·전후반이 모두 양수다(단, 2022 F −34.751). Trackman/구종 라벨은 제출 ZIP에 없고 행 독립 감사 최대 차이 0. 오프라인 gate는 통과했으나 LB 미관측이라 제출 전까지 잠정 PASS.
