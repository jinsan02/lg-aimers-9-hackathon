...
FLAG masked-pitch-auxiliary-lagged-artifact | CANDIDATE | 원래 rolling paired +89.858/+72.361/+18.432, t=7.882/4.980/4.083; fixed-w10 route +14.891/+140.131/+9.390 | 통과 실험과 동일하게 artifact/vocab/QT≤S−2, 모델≤S−1, target S 구조만 허용한다. 2025 후보 v14는 전처리≤2023·학습≤2024이며 v13 대비 유일한 변경은 전처리 cutoff다. 가중치·slope/shift·recent-middle/PB는 고정, ZIP/행독립 감사 통과, LB 미관측.
