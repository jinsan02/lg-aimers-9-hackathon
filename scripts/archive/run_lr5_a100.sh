...
~/venv451/bin/python tools/precheck.py "${COMMON[@]}" --val-season 2023 --test-season 2024 --tag LR5A
~/venv451/bin/python src/train_gbdt2.py "${COMMON[@]}" --val-season 2023 --test-season 2024 --tag LR5A
