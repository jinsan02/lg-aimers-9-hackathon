"""최종 블렌드 v3 (CatBoost 6종 + XGBoost 1종, 피처 v2) — 제출 zip의 script.py.

가중치: 2024 홀드아웃 greedy ensemble selection (로컬 BSS 804.70).
...
WEIGHTS = [("./model/cat_hs_d7_l10_r0.08.pkl", 0.200),
           ("./model/cat_hs_d8_l3_r0.05.pkl", 0.200),
           ("./model/cat_fv2s3.pkl", 0.200),
           ("./model/cat_hs_d8_l10_r0.05.pkl", 0.100),
           ("./model/cat_fv2.pkl", 0.100),
           ("./model/cat_fv2s4.pkl", 0.100),
           ("./model/xgb_fv2.pkl", 0.100)]
