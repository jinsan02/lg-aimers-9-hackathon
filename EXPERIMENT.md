...
## 2026-08-11 masked 구종 보조학습 — v13 실패, v14 구조 수정
...
원래 통과한 구조를 평행 이동한 `전처리≤2023, 모델≤2024, 예측2025` v14를 새로 만들었다.
가중치 10%, slope/shift, recent-middle/PB는 바꾸지 않았다. 후보는
`submissions/v14_pitch_mtl_lag_0811.zip`; 압축 해제 smoke와 행 독립 감사 최대 차이는 0,
LB는 아직 미관측이다. 현재 챔피언은 계속 v11이다. 상세:
